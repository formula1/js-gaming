(function (root, factory) {
    ...
    templatizer["body"] = function tmpl_body() {
        return '<body><nav class="navbar navbar-default"><div class="container-fluid"><div class="navbar-header"><a href="/" class="navbar-brand">JS Gaming</a></div><ul class="nav navbar-nav"><li><a href="/">chat</a></li><li><a href="/info">more info</a></li></ul><div class="pull-right"><strong>Welcome, </strong><strong data-hook="name"></strong></div></div></nav><div class="container"><main data-hook="page-container"></main></div></body>';
    };
